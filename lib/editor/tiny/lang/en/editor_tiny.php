...
$string['includethemecss'] = 'Include theme CSS in editor';
$string['includethemecss_desc'] = 'When enabled, the editor will use the main theme CSS in addition to editor-specific CSS, providing a more consistent look between editing and viewing content.';
